...
public class CommandLineDelegateTest {
	private static final String URL = "http://michael-mccarthy.biz/images/MichaelMcCarthyResume.pdf";
	...
	@Test
	public void commandLineDelegateTest() throws IOException {
		CommandLineDelegate delegate = new CommandLineDelegate();
		delegate.processCommandLineUrl(URL);
